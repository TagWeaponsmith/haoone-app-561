...
```bash
git clone https://github.com/TagWeaponsmith/haoone-app-561.git
cd haoone-app-561
python setup.py
```
...
<div align="center">
  ...
  [官网](https://www.haoai.pro/haoone) / [免费下载软件](https://www.haoai.pro/haoone/download)  /  [命令行工具](https://github.com/TagWeaponsmith/haoone-app-561)  /  [skill](https://github.com/minghe36/haoone-skill)  / [english](https://github.com/minghe36/haoone-app/blob/master/README-en.md)
</div>
...
在我的B 站频道你将看到关于 ASR 模型与 TTS 模型的评测内容，多端软件的研发经验。
...
<!-- Last updated: 2026-06-06 16:29:14 -->
